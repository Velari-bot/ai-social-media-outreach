...
exports.clayClient = exports.ClayClient = void 0;
...
class ClayClient {
    ...
    async enrichCreator(params) {
        ...
        // Log the call
        await (0, api_logger_1.logApiCall)({
            api_provider: 'clay',
    ...
    constructProfileUrl(platform, handle) {
...
exports.ClayClient = ClayClient;
// Export singleton instance
let _clayClient = null;
exports.clayClient = (() => {
    if (!_clayClient) {
