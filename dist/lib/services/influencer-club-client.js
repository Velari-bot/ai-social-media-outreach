...
exports.influencerClubClient = exports.InfluencerClubClient = void 0;
...
class InfluencerClubClient {
    ...
    parseTopics(rawNiche) {
        if (!rawNiche || rawNiche === 'any')
            return { niche: rawNiche };
    ...
    buildPayload(platform, page, limit, minFollowers, maxFollowers, niche, category, location, minAvgViews) {
        const body = {
            platform,
            paging: { limit, page },
            filters: {
    ...
    async executeRequest(body, requestId) {
        try {
...
exports.InfluencerClubClient = InfluencerClubClient;
let _influencerClubClient = null;
exports.influencerClubClient = (() => {
